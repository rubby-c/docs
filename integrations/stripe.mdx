...
This is done by specifying an `_afficoneRef` property in the customer metadata.
...
<Tip>
You can pass the referral code from the browser with your API call - a good example is during registration.
</Tip>